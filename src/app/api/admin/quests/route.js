...
export async function POST(request) {
  ...
  const r = await q(
    'INSERT INTO quests (code, title, order_no, quest_group, main_no, main_title, place, cover_image_url, narration_video, clear_text, clear_audio_url, reward_points, is_active) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)',
    [code, b.title || '제목없음', b.order_no || 0, b.quest_group ?? 1, b.main_no ?? 1, b.main_title || null, b.place || null, b.cover_image_url || null, b.narration_video || null, b.clear_text || null, b.clear_audio_url || null, b.reward_points ?? 100, b.is_active ?? 1]);
