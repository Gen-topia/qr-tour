...
export async function GET(request, { params }) {
  ...
  const [quest] = await q(
    'SELECT id, title, header_title, screen_title, quest_group, cover_image_url, clear_image_url, narration_video, clear_text, clear_audio_url FROM quests WHERE id=?', [id]
  );
