...
| `11-haenyeo` | 입구 해녀의 이야기 | DQAHS3 | ○ 해녀의 목소리 | – | – |
| `12-windcenter` | 풍력센터 · 해녀 회장 이야기 | CLDQYL |
| `13-dageumbari` | 풍력센터 · 다금바리 이야기 | D7CE3L | ○ 해녀 회장님 목소리 | ○ 물에서 튀어 오르는 소리 + 다금바리 목소리 | ○ 해녀 회장님 목소리 |
| `14-ieodo` | 이어도 길(엔딩) | VSEHEK | ○ 신성한 하늘의 악기 소리가 들리는 배경음악 | ○ 알림음(설문대할망 메시지 도착) | ○ 설문대할망 목소리 |
...
## 2026-08-19 — 퀘스트3 QR 분리

대본 40p의 `설치 : 다금바리 QR`에 맞춰 풍력센터를 QR 둘로 갈랐다.
`12-windcenter/action.mp3`(다금바리 대사)는 `13-dageumbari/start.mp3`로 옮겼고,
이어도 길 폴더는 `13-ieodo` → `14-ieodo`로 한 칸 밀렸다.

| QR | 코드 | 미션 | 폴더 |
|---|---|---|---|
| QR12 | DQAHS3 | 입구 해녀의 이야기 | `11-haenyeo` |
| QR13 | CLDQYL | 풍력센터 · 해녀 회장 이야기 | `12-windcenter` |
| QR14 | D7CE3L | 풍력센터 · 다금바리 이야기 | `13-dageumbari` |
| QR15 | VSEHEK | 이어도 길(엔딩) | `14-ieodo` |
